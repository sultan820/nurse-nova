...
export default function createHomeStack(props) {
    return (
        <Stack.Navigator headerMode="none" >
            ...
            <Stack.Screen options={{
                headerTitle: (navigation) => <ClosingHeader {...props} title="Add New Member" />,
                headerTitleContainerStyle: { left: 0, top: 0, bottom: 0 }
            }} name="AddPhotoRegistration" component={AddPhoto} />
