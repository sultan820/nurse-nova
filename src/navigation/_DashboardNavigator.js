...
export default function DashboardNavigator(props) {
  ...
  return (
    <DashNavigator.Navigator headerMode='screen'>
      <DashNavigator.Screen
        component={_MedicalRecordList} name="MyMedicalRecords"
        options={{
          headerTitle: () => <DashboardStackHeader {...props} title={langjson.lang[language - 1].recordTitle} />,
      ...
      <DashNavigator.Screen
        ...
        options={{
          headerTitle: (navigation) => <DashboardStackHeader {...props} title="My Medical Records" />,
          headerTitleContainerStyle: { left: 0, top: 0, bottom: 0 }
        }}
      />
      <DashNavigator.Screen
        ...
        options={{
          headerTitle: () => <ClosingHeader {...props} title="Create Medical Record" />,
          headerTitleContainerStyle: { left: 0, top: 0, bottom: 0 },
      ...
      <DashNavigator.Screen
        ...
        options={{
          headerTitle: () => <ClosingHeader {...props} title="Edit Medical Record" />,
          headerTitleContainerStyle: { left: 0, top: 0, bottom: 0 },
          // headerStyle:{height:60},
        }}
      />
      {/* <DashNavigator.Screen
        ...
        options={{
          headerTitle: () => <ClosingHeader {...props} title={"Record Detail"} />,
          headerTitleContainerStyle: { left: 0, top: 0, bottom: 0 },
          // headerStyle:{height:hp},
        }}
      /> */}
