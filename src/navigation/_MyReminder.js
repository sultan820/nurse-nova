  ...
  return (
    <DashNavigator.Navigator headerMode='float'>
      <DashNavigator.Screen
        ...
        options={{
          headerTitle: () => <DashboardStackHeader {...props} title="My Medical Reminders" />,
      ...
      <DashNavigator.Screen
        ...
        options={{
          headerTitle: (navigation) => <DashboardStackHeader {...props} title="My Medical Reminder" />,
          headerTitleContainerStyle: { left: 0, top: 0, bottom: 0 }
        }}
      />
      <DashNavigator.Screen
        ...
        options={{
          headerTitle: (navigation) => <ClosingHeader {...props} title="Create Medical Reminder" />,
          headerTitleContainerStyle: { left: 0, top: 0, bottom: 0 }
        }}
      />
      <DashNavigator.Screen
        ...
        options={{
          headerTitle: () => <ClosingHeader {...props} title="Select Family Member" />,
          headerTitleContainerStyle: { left: 0, top: 0, bottom: 0 },
          // headerStyle:{height:60},
        }}
      />
      <DashNavigator.Screen
        component={Openclock} name="openclock"
        options={{
          headerTitle: () => <ClosingHeader {...props} title="Set Remainder" />,
          headerTitleContainerStyle: { left: 0, top: 0, bottom: 0 },
          // headerStyle:{height:60},
        }}
      />
