  ...
  return (
    <DashNavigator.Navigator headerMode='float' initialRouteName="Communities">
      ...
      <DashNavigator.Screen
        ...
        options={{
          headerTitle: () => <CommunityStackHeader {...props} title="Community" />,
      ...
      <DashNavigator.Screen
        ...
        options={{
          headerTitle: (navigation) => <CommunityStackHeader {...props} title="Community" />,
          headerTitleContainerStyle: { left: 0, top: 0, bottom: 0 }
        }}
      />
      ...
      <DashNavigator.Screen
        ...
        options={{
          headerTitle: (navigation) => <CommunityStackHeader {...props} title="Published By" />,
          headerTitleContainerStyle: { left: 0, top: 0, bottom: 0 }
        }}
      />
      ...
      <DashNavigator.Screen
        ...
        options={{
          headerTitle: (navigation) => <CommunityStackHeader {...props} title="Filter By Topic" />,
          headerTitleContainerStyle: { left: 0, top: 0, bottom: 0 }
        }}
      />
      ...
      <DashNavigator.Screen
        ...
        options={{
          headerTitle: (navigation) => <ClosingHeader {...props} title="Create New Article" />,
          headerTitleContainerStyle: { left: 0, top: 0, bottom: 0 }
        }}
      />
