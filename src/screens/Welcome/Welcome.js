  ...
  constructor(props) {
    ...
    this.state = {
      ...
      carouselItems: [
        ...
        {
          title:
            'Tracking your daily symptoms can help you and your doctors make better decisions',
      ...
      <View>
        <View style={Styles.button}>
          <Button
            ...
            {langjson.lang[language - 1].welcomestartbutton}
          </Button>
        </View>
        <View style={Styles.button}>
          <Button
            ...
            status="info">
            {langjson.lang[language - 1].welcomeloginbutton}
          </Button>
        </View>
      </View>
    );
