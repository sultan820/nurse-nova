...
export default function Clock(props) {
    ...
    const skipAlarms = async (item) => {
        ...
        console.console("List length", List.length)
            ...
            <View style={{ paddingHorizontal: 15, paddingVertical: 5 }}>
                <TouchableOpacity onLongPress={() => { confirmDelete(item.id) }}
                    ...
                    <View style={{ flex: 3 }}>
                        <View style={{ flex: 1, flexDirection: 'row' }} >
                            <View style={{ flex: 1.5, justifyContent: 'center' }} >
                                ...
                                >
                                    ...
                                    <Text style={[styles.time, { color: '#fff', fontSize: 16, fontWeight: 'bold', marginLeft: 0, textAlign: 'left', paddingLeft: 4, fontFamily: 'OpenSans-Light' }]}>
                        ...
                        <View style={{ flex: 1, }}>
                            <Text style={[styles.pill, { fontFamily: 'OpenSans-Light', fontWeight: 'bold', marginBottom: 15 }]}>{reminder.OtherMedicineDoze}</Text>
                        </View>
                    </View>
