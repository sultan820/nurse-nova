...
import { View, Text,TouchableOpacity,Image, ActivityIndicator, RefreshControl, FlatList} from 'react-native'
    ...
    return (
        <View style={Styles.mainContainer}>
           ...
           <TouchableOpacity
                ...
                onPress={()=>props.navigation.navigate('AddNewMember', {familyMember: ''})}
                >
