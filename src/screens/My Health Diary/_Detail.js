...
function _Detail(props) {
  ...
  const getRecord = async () => {
    props.navigation.setOptions({
      headerTitle: () => (
        <ClosingHeader {...props} title="Create Health Diary" />
      ),
    });
                ...
                <Layout style={Styles.content}>
                  <View
                    ...
                    <Text
                      ...
                      style={{padding: 10, fontSize: 16, color: '#596377'}}>
                      <Icon
                        name="edit-2"
                        type="Feather"
          ...
          <Row
            ...
            <Col>
              <Text style={{fontSize: 15}}>
                File Type:{' '}
                {record.healthDiaryType !== 'Other'
                  ? record.healthDiaryType
                  : record.healthDiaryTypeOther == ''
                  ? record.healthDiaryType
                  : record.healthDiaryTypeOther}
              </Text>
            </Col>
              ...
              <Row style={{paddingHorizontal: 25, paddingVertical: 12}}>
                {record.files != null &&
                  record.files.map((f, index) => {
                    ...
                    console.log('url image ', IMAGE_URL + f.file_src);
