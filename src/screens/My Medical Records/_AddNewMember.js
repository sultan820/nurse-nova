...
import { View, Platform, Text, TouchableOpacity, Image, FlatList, RefreshControl, ActivityIndicator } from 'react-native'
...
function _AddNewMember(props) {
    ...
    useEffect(() => {
        console.log("_AddNewMember12", props)
        ...
        <View style={[Styles.mainContainer,]}>
            <View style={Styles.addNewMemberContainer}>
                <TouchableOpacity
                    ...
                    onPress={() => props.navigation.navigate('Medical Record Form', { familyMember: '' })}
                >
