...
import { View, Text, TouchableOpacity, Image, RefreshControl, Alert, Share, Modal, SafeAreaView } from 'react-native'
                ...
                <Popover
                    ...
                    <Layout
                        ...
                        <View>
                            <Text
                                onPress={() => {
                                    setVisible(false); props.navigation.navigate('Medical Record Form', {
                                        medicalRecord: List.filter(l =>
                                            l.id == id
                                        )[0]
                                    })
                                }}
