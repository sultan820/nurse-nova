                ...
                <View style={{ width: '100%' }}>
                    ...
                    <View style={{ width: '100%', flexDirection: 'row' }} >
                        <View style={{ justifyContent: 'center' }} >
                            ...
                            <Text style={{ fontSize: 16, paddingLeft: 26, fontFamily: "OpenSans-Light", color: '#596377', lineHeight: 22 }}>
                    ...
                    <View style={{ width: '100%', flexDirection: 'row' }} >
                        <View style={{ justifyContent: 'center' }} >
                            <Text style={{ fontSize: 16, paddingLeft: 26, fontFamily: "OpenSans-Light", color: '#596377', lineHeight: 22 }}>{item.address}</Text>
                        </View>
                        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'flex-end' }} >
        ...
        <View style={Styles.mainContainer}>
            ...
            <View style={{ height: 60, justifyContent: 'center', marginRight: 23, marginLeft: 23, }}>
                <TextInput style={{ height: 60 }} onChangeText={(text) => filterDoctor(text)} placeholder="Search by doctor name..."
                    style={{ backgroundColor: '#fff', borderRadius: 10, borderWidth: 2, borderColor: '#eaecef', paddingLeft: 20, fontFamily: 'OpenSans-Light', fontWeight: '900' }} />
