...
export default function AddPhoto(props) {
    ...
    const getReturnUrl = () => {
        //props.navigation.setOptions({ headerTitle: () => <ClosingHeader {...props} title="Add Photo" /> });
        ...
        <View style={Styles.mainContainer}>
                ...
                <View style={Styles.headerContainer}>
                    <View style={{ flexDirection: "row", justifyContent: "space-between", flexGrow: 0.5, alignItems: "center" }}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => navigation.navigate('AddNewMember', { returnURL, item: props.route.params.item })}>
            ...
            <View>
                <Button block onPress={() => {
                    ...
                    navigation.navigate('AddNewMember', { file, returnURL, item: props.route.params.item })
                }}>Create</Button>
            </View>
