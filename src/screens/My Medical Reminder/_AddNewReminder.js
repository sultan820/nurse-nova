...
export default function _AddNewReminder(props) {
  ...
  const saveReminder = () => {
    ...
    AsyncStorage.getItem('loginData').then((user) => {
      ...
      if (update) {
        ...
        // return;
        let _prev_reminder_dts =
          props.route.params.reminder[0].reminderDateTimes;
        let ids = [];
        if (_prev_reminder_dts.length > 0) {
          _prev_reminder_dts.forEach((item, index) => {
            ids.push(recordID + '' + index);
          });
        }
        ids.forEach((item) =>
        ...
        auth
          .update({Reminder: formData})
          .then((res) => res.json())
          .then((res) => {
            console.log(
              'some response after adding data',
  ...
  const getProps = () => {
    if (props.route.params != undefined) {
      console.log(
        'params while editing',
        JSON.stringify(props.route.params, null, 4),
      );
      props.navigation.setOptions({
        headerTitle: () => (
          <ClosingHeader {...props} title="Create Medical Reminder" />
        ),
      });
      ...
      if (params.reminder !== undefined) {
        ...
        setUpdate(true);
        let id_to_increment_from =
          params.reminder[0].id +
          '' +
          params.reminder[0].reminderDateTimes.length;
      ...
      if (everday) {
        ...
        for (let i = 0; i < dates.length; i++) {
          ...
          await createAlarm({
            date,
            message:
              'Time to get medicine: ' + medicine + ' doze: ' + otherDose,
            snooze,
            id,
            _id: id + '' + i,
        ...
        for (let i = 0; i < dates.length; i++) {
          date = moment(
            dates[i].ReminderDate + ' ' + dates[i].ReminderTime,
          ).format();
  ...
  return (
    <>
        ...
        <Content>
          ...
          <Row style={{marginTop: 5}}>
            <Col style={{marginRight: 5}}>
              <LinearGradient
                colors={dose == 1 ? active : ['transparent', 'transparent']}
                start={{x: 0.0, y: 0}}
                end={{x: 1.8, y: 1.0}}>
                <Button
                  onPress={() => setDose(1)}
                  ...
                  <Text
                    style={[
                      dose == 1 ? styles.activeText : styles.defaultText,
                    ]}>
                    1 Pill
                  </Text>
                </Button>
            ...
            <Col style={{marginRight: 5}}>
              <LinearGradient
                colors={dose == 0.5 ? active : ['transparent', 'transparent']}
                start={{x: 0.0, y: 0}}
                end={{x: 1.8, y: 1.0}}>
                <Button
                  onPress={() => setDose(0.5)}
                  ...
                  <Text
                    style={[
                      dose == 0.5 ? styles.activeText : styles.defaultText,
                    ]}>
                    0.5 Pill
                  </Text>
                </Button>
            ...
            <Col style={{marginRight: 5}}>
              <LinearGradient
                colors={dose == 2 ? active : ['transparent', 'transparent']}
                start={{x: 0.0, y: 0}}
                end={{x: 1.8, y: 1.0}}>
                <Button
                  onPress={() => setDose(2)}
                  ...
                  <Text
                    style={[
                      dose == 2 ? styles.activeText : styles.defaultText,
                    ]}>
                    2 Pills
                  </Text>
                </Button>
          ...
          <Row>
            <Col style={{marginRight: 5, marginTop: 10}}>
              <LinearGradient
                colors={
                  otherDose == 'Other' ? active : ['transparent', 'transparent']
                }
                start={{x: 0.0, y: 0}}
                end={{x: 1.8, y: 1.0}}>
                <Button
          ...
          {showCustom == 'pill' && (
            <Row style={{marginTop: 10}}>
              <Col style={{marginRight: 5}}>
                <Item regular>
                  <Input
                    placeholder="Enter custom pills"
          ...
          <Row>
            <Col style={{marginRight: 5}}>
              <LinearGradient
                colors={
                  dose == '5 ml' ? active : ['transparent', 'transparent']
                }
                start={{x: 0.0, y: 0}}
                end={{x: 1.8, y: 1.0}}>
                <Button
                  onPress={() => setDose('5 ml')}
                  style={[
                    dose == '5 ml'
                      ? {backgroundColor: 'transparent'}
                      : styles.default,
                  ...
                  <Text
                    style={[
                      dose == '5 ml' ? styles.activeText : styles.defaultText,
                    ]}>
                    5 ml
                  </Text>
                </Button>
            ...
            <Col style={{marginRight: 5}}>
              <LinearGradient
                colors={
                  dose == '10 ml' ? active : ['transparent', 'transparent']
                }
                start={{x: 0.0, y: 0}}
                end={{x: 1.8, y: 1.0}}>
                <Button
                  onPress={() => setDose('10 ml')}
                  style={[
                    dose == '10 ml'
                      ? {backgroundColor: 'transparent'}
                      : styles.default,
                  ...
                  <Text
                    style={[
                      dose == '10 ml' ? styles.activeText : styles.defaultText,
                    ]}>
                    10 ml
                  </Text>
                </Button>
            ...
            <Col style={{marginRight: 5}}>
              <LinearGradient
                colors={
                  dose == '15 ml' ? active : ['transparent', 'transparent']
                }
                start={{x: 0.0, y: 0}}
                end={{x: 1.8, y: 1.0}}>
                <Button
                  onPress={() => setDose('15 ml')}
                  style={[
                    dose == '15 ml'
                      ? {backgroundColor: 'transparent'}
                      : styles.default,
                  ...
                  <Text
                    style={[
                      dose == '15 ml' ? styles.activeText : styles.defaultText,
                    ]}>
                    15 ml
                  </Text>
                </Button>
          ...
          <Row style={{marginTop: 5}}>
            <Col style={{marginRight: 5}}>
              <LinearGradient
                colors={
                  dose == '20 ml' ? active : ['transparent', 'transparent']
                }
                start={{x: 0.0, y: 0}}
                end={{x: 1.8, y: 1.0}}>
                <Button
                  onPress={() => setDose('20 ml')}
                  style={[
                    dose == '20 ml'
                      ? {backgroundColor: 'transparent'}
                      : styles.default,
                  ...
                  <Text
                    style={[
                      dose == '20 ml' ? styles.activeText : styles.defaultText,
                    ]}>
                    20 ml
                  </Text>
                </Button>
            ...
            <Col style={{marginRight: 5}}>
              <LinearGradient
                colors={
                  dose == '25 ml' ? active : ['transparent', 'transparent']
                }
                start={{x: 0.0, y: 0}}
                end={{x: 1.8, y: 1.0}}>
                <Button
                  onPress={() => setDose('25 ml')}
                  style={[
                    dose == '25 ml'
                      ? {backgroundColor: 'transparent'}
                      : styles.default,
                  ...
                  <Text
                    style={[
                      dose == '25 ml' ? styles.activeText : styles.defaultText,
                    ]}>
                    25 ml
                  </Text>
                </Button>
          ...
          <Row style={{marginTop: 10}}>
            <Col style={{marginRight: 11}}>
              <LinearGradient
                colors={everday ? active : ['transparent', 'transparent']}
                start={{x: 0.0, y: 0}}
                end={{x: 1.8, y: 1.0}}>
                <Button
                  onPress={() => {
                  ...
                  style={[
                    everday ? {backgroundColor: 'transparent'} : styles.default,
                  ]}>
                  <Text
                    style={[everday ? styles.activeText : styles.defaultText]}>
                    Everyday
                  </Text>
                </Button>
              </LinearGradient>
          ...
          <Row style={{marginTop: 10}}>
            <Col>
              <Text>
                Add the photo of your medicine, so it can appear on your
                reminder.
              </Text>
            </Col>
          </Row>
          ...
          <Modal
            transparent={true}
            onBackdropPress={() => setShowLiftime(false)}
            animated={true}
            onRequestClose={() => setShowLiftime(false)}
            isVisible={showLifetime}
            style={{
              flex: 1,
              position: 'absolute',
              bottom: 50,
            ...
            <View
              ...
              <LinearGradient
                ...
                colors={isLifeTime ? active : ['transparent', 'transparent']}
                start={{x: 0.0, y: 0}}
                end={{x: 1.8, y: 1.0}}>
                <Button
                  onPress={() => {
                    setLiftime(!isLifeTime);
                    console.warn('lifetime Pressed', isLifeTime);
                  }}
                  style={[styles.default, {height: 50, width: 150}]}>
                  <Text
                    style={{
                      color: 'black',
                      fontSize: 18,
              ...
              <View
                style={{alignItems: 'center', padding: 5, marginVertical: 10}}>
                <Text>Or</Text>
              </View>
              <View
                style={{
                ...
                <TouchableOpacity
                  onPress={() => {
                    numberOfDays > 0 ? setNumberOfDays(numberOfDays - 1) : null;
                    setLiftime(false);
                    console.warn(isLifeTime);
                  }}
                  style={{
                    width: 60,
                    height: 50,
            ...
            <Button
              ...
              onPress={() => {
                setShowLiftime(false);
                props.navigation.navigate('openclock');
              }}
              appearance="primary"
              status="primary"
              style={{marginTop: 10}}
      ...
      <Button
        accessoryLeft={() => (loading ? LoadingIndicator() : null)}
        onPress={!loading ? saveReminder : null}
        appearance="primary"
        status="primary"
        style={Styles.button}
        size="large"
