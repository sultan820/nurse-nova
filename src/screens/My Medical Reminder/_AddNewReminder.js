...
export default function _AddNewReminder(props) {
  ...
  return (
    <>
      <ScrollView contentContainerStyle={{ padding: wp("6%"), backgroundColor: theme.colors.white, paddingBottom: 0 }}>
        <Content>
          ...
          <Row style={{ marginTop: 5 }}>
            <Col style={{ marginRight: 5 }}>
              <LinearGradient colors={dose == 1 ? active : ["transparent", 'transparent']} start={{ x: 0.0, y: 0 }} end={{ x: 1.8, y: 1.0 }}>
                <Button onPress={() => setDose(1)} style={[dose == 1 ? { backgroundColor: 'transparent' } : styles.default]}>
                  <Text style={[dose == 1 ? styles.activeText : styles.defaultText]}>1 Pill</Text>
                </Button>
              </LinearGradient>
            </Col>
            <Col style={{ marginRight: 5 }}>
              <LinearGradient colors={dose == 0.5 ? active : ["transparent", 'transparent']} start={{ x: 0.0, y: 0 }} end={{ x: 1.8, y: 1.0 }}>
                <Button onPress={() => setDose(0.5)} style={[dose == 0.5 ? { backgroundColor: 'transparent' } : styles.default]}>
                  <Text style={[dose == 0.5 ? styles.activeText : styles.defaultText]}>0.5 Pill</Text>
                </Button>
              </LinearGradient>
            </Col>

            <Col style={{ marginRight: 5 }}>
              <LinearGradient colors={dose == 2 ? active : ["transparent", 'transparent']} start={{ x: 0.0, y: 0 }} end={{ x: 1.8, y: 1.0 }}>
                <Button onPress={() => setDose(2)} style={[dose == 2 ? { backgroundColor: 'transparent' } : styles.default]}>
                  <Text style={[dose == 2 ? styles.activeText : styles.defaultText]}>2 Pills</Text>
                </Button>
              </LinearGradient>
            </Col>
          </Row>
          ...
          <Modal transparent={true} onBackdropPress={() => setShowLiftime(false)} animated={true} onRequestClose={() => setShowLiftime(false)} isVisible={showLifetime}
            ...
            <View style={{ backgroundColor: theme.colors.white, width: wp("90%"), height: wp("70%") }}>
              ...
              <LinearGradient style={{ alignItems: 'center' }} colors={isLifeTime ? active : ["transparent", 'transparent']} start={{ x: 0.0, y: 0 }} end={{ x: 1.8, y: 1.0 }}>
                <Button onPress={() => { setLiftime(!isLifeTime); console.warn("lifetime Pressed", isLifeTime) }} style={[styles.default, { height: 50, width: 150 }]}>
                  <Text style={{ color: "black", fontSize: 18, fontWeight: "100", width: '100%' }} >Lifetime</Text>
                </Button>
              </LinearGradient>
...
const styles = StyleSheet.create({
  default: { backgroundColor: 'transparent', borderRadius: 0, borderColor: '#222', borderWidth: 1, borderColor: "#EAECEF", overflow: "visible", padding: 10 },
